            ...
            <form action=" {{ route ('staffs.profileUpdate') }} " method="post">
                ...
                <div>
                    <div class="flex items-center">
                        ...
                        <a class=" mt-8 px-3 flex bg-maroon-100 justify-center text-white rounded block" style="width: 100px; height: 30px; margin-right: 50px; margin-left: 50px;" href="{{ route ('staffs.dashboard') }}">
                            Back
                        </a>
                    </div>
                </div>
